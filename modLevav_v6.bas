...
10      Dim p As String
20      p = SOURCE_FOLDER & yearVal & ".xlsx"
30      If Dir$(p) <> "" Then
40          FindSourceFile = p
50          Exit Function
60      End If
70      p = SOURCE_FOLDER & yearVal & ".xls"
80      If Dir$(p) <> "" Then
90          FindSourceFile = p
100         Exit Function
110     End If
...
1030        rng.Validation.Delete
1040        rng.Validation.Add Type:=xlValidateList, AlertStyle:=xlValidAlertStop, Formula1:=ChrW(1514) & ChrW(1511) & ChrW(1503) & "," & ChrW(1492) & ChrW(1514) & ChrW(1506) & ChrW(1500) & ChrW(1501)
...
1360    MsgBoxU wsMsgSrc.Cells(5, 19).Value & Erl & vbCrLf & wsMsgSrc.Cells(6, 19).Value & Err.Number & vbCrLf & Err.Source & vbCrLf & Err.Description, vbCritical
